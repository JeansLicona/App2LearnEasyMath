    ...
    <head>
        ...
        <script type="text/javascript">
			...
			/*
				...
				get_messages_by_date( month + "/" + day + "/" + year);
			*/
            });
	/*		
function get_messages()
{
   $.get( "comments.php",
		...
		$(".demoHeaders").remove();
		$("#container_messages").remove();
		
		//$("#accordion").append(respuesta);
...
<!--
<p id="container_dialog" ><a href="#" id="dialog-link" class="ui-state-default ui-corner-all"><span class="ui-icon ui-icon-newwin"></span>Add comment</a></p>
-->
