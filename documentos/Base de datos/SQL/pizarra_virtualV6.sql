...
CREATE  TABLE IF NOT EXISTS `tutor` (
  ...
  INDEX `fk_tutor_usuario1_idx` (`usuario` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `chat_general` (
  ...
  PRIMARY KEY (`id_chat`) ,
  INDEX `fk_chat_general_idx` (`usuario_id` ASC) ,
  CONSTRAINT `fk_chat_general`
...
CREATE  TABLE IF NOT EXISTS `chat_grupo` (
  ...
  `fecha` DATETIME NOT NULL ,
  PRIMARY KEY (`id_chat`) ,
  INDEX `fk_chat_grupo_usuario_idx` (`usuario_id` ASC) ,
  INDEX `fk_chat_grupo_grupo_idx` (`grupo_id` ASC) ,
  CONSTRAINT `fk_chat_grupo_usuario`
    FOREIGN KEY (`usuario_id` )
    REFERENCES `usuario` (`id_usuario` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_chat_grupo_grupo`
...
CREATE  TABLE IF NOT EXISTS `usuario_grupo` (
  ...
  INDEX `fk_usuario_grupo_usuario_idx` (`usuario_id` ASC) ,
  INDEX `fk_usuario_grupo_grupo_idx` (`grupo_id` ASC) ,
