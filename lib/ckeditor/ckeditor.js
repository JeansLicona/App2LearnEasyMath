        ...
        (function() {
                    ...
                    once: function() {
                        ...
                        return function(l, h, k) {
                            ...
                            if (o) {
                                var q = o.listeners;
                                if (q.length)
                                    for (var q = q.slice(0), u, f = 0; f < q.length; f++) {
                                        if (o.errorProof)
                                            try {
                                                u = q[f].call(this,
                                                        k, h, e, g)
            ...
            (function() {
                ...
                CKEDITOR.tools = {arrayCompare: function(b, a) {
                        ...
                        for (var b = [].concat(b), a, e = [], i = 0; i < b.length; i++)
                            if (a = b[i]) / @import | [{}] / .test(a) ? e.push("<style>" + a + "</style>") : e.push('<link type="text/css" rel=stylesheet href="' + a + '">');
                        return e.join("")
            ...
            CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {appendTo: function(a, d) {
                    ...
                    var b = this.$.cloneNode(a), c = function(e) {
                        ...
                        if (e.nodeType == CKEDITOR.NODE_ELEMENT) {
                            ...
                            if (a)
                                for (var e = e.childNodes, b = 0; b < e.length; b++)
                                    c(e[b])
                        }
                    };
                    c(b);
                    ...
                    if (this.type == CKEDITOR.NODE_ELEMENT && a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if ("sourceIndex"in d)
                            return d.sourceIndex < 0 || b.sourceIndex < 0 ? CKEDITOR.POSITION_DISCONNECTED : d.sourceIndex < b.sourceIndex ? CKEDITOR.POSITION_PRECEDING : CKEDITOR.POSITION_FOLLOWING
                    }
            ...
            CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {type: CKEDITOR.NODE_DOCUMENT, appendStyleSheet: function(a) {
                    ...
                    for (var b = this.$.documentElement, c =
                        ...
                        var e = a[c];
                        if (d)
                            for (var i = -1, g = 0; g < b.childNodes.length; g++) {
                    ...
                    if ((!CKEDITOR.env.ie || document.documentMode > 8) && d)
                        a = d + ":" + a;
            ...
            (function() {
                ...
                function b(a) {
                    for (var b = 0, d = 0, l = c[a].length; d < l; d++)
                ...
                CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {type: CKEDITOR.NODE_ELEMENT, addClass: function(a) {
                    ...
                    isEmptyInlineRemoveable: function() {
                        ...
                        if (o < 0 || h > 0)
                            s(0, b === true ? o : b === false ? h : o < 0 ? o : h);
                        if (c && (k < 0 || d > 0))
                            s(k < 0 ? k : d, 0)
                        ...
                        for (var c = this.$.attributes, b = b || {}, d = 0; d < c.length; d++) {
                            ...
                            if (!(k in b))
                                if (k == "checked" && (o = this.getAttribute(k)))
                                    a.setAttribute(k, o);
                                else if (h.specified || CKEDITOR.env.ie && h.nodeValue && k == "value") {
                        ...
                        if (!c && (!b || this.type == b))
                            var d = a(this);
                        if (d !== false)
                            for (var c = this.getChildren(), h = 0; h < c.count(); h++) {
                                d = c.getItem(h);
            ...
            (function() {
                function a(a, b) {
                    ...
                    if (!a && !this._.guardLTR) {
                        ...
                        this._.guardLTR = function(a, b) {
                            return(!b || !h.equals(a)) && (!t ||
                                    !a.equals(t)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                        }
                    }
                    ...
                    if (this.current)
                        f = this.current[i](false, n, m);
                    else {
                        if (a)
                            f.type ==
                                    CKEDITOR.NODE_ELEMENT && (f = d > 0 ? f.getChild(d - 1) : m(f, true) === false ? null : f.getPreviousSourceNode(true, n, m));
                        else {
                            f = e;
                            if (f.type == CKEDITOR.NODE_ELEMENT && !(f = f.getChild(o)))
                                f = m(e, true) === false ? null : e.getNextSourceNode(true, n, m)
                        }
                        f && m(f) === false && (f = null)
                    }
                    for (; f && !this._.end; ) {
                ...
                CKEDITOR.dom.element.prototype.getBogus = function() {
                    ...
                    while (l(a) || g(a) || a.type == CKEDITOR.NODE_ELEMENT && a.is(CKEDITOR.dtd.$inline) && !a.is(CKEDITOR.dtd.$empty));
            ...
            (function() {
                ...
                var c = function(a) {
                    ...
                    for (var t = c, k, G, l, B = n; B < i.length; B++) {
                        ...
                        for (k = k.getNext(); k; ) {
                            if (k.equals(h[B]) || k.equals(d))
                                break;
                            l = k.getNext();
                            if (b == 2)
                                t.append(k.clone(true));
                            else {
                                k.remove();
                                b == 1 && t.append(k)
                            }
                    ...
                    for (c = n; c < h.length; c++) {
                        ...
                        if (!i[c] || k.$.parentNode != i[c].$.parentNode)
                            for (k = k.getPrevious(); k; ) {
                                if (k.equals(i[c]) || k.equals(f))
                                    break;
                                l = k.getPrevious();
                                if (b == 2)
                                    t.$.insertBefore(k.$.cloneNode(true), t.$.firstChild);
                                else {
                                    k.remove();
                        ...
                        {clone: function() {
                                ...
                                function a(b) {
                                    ...
                                    if (c.type == CKEDITOR.NODE_TEXT) {
                                        f = c;
                                        for (d = 0; (f = f.getPrevious()) && f.type == CKEDITOR.NODE_TEXT; )
                                            d = d + f.getLength();
                                        e = e + d
                                    }
                                    b.container = c;
                            ...
                            getBoundaryNodes: function() {
                                ...
                                if (b.type == CKEDITOR.NODE_ELEMENT) {
                                    f = b.getChildCount();
                                    if (f > e)
                                        b = b.getChild(e).getPreviousSourceNode(true);
                                    else if (f < 1)
                                ...
                                switch (a) {
                                    ...
                                    case CKEDITOR.ENLARGE_ELEMENT:
                                        ...
                                        for (j = c(j); j || n; ) {
                                            if (j && !n) {
                                                !r && j.equals(d) && (r = true);
                                                if (f ? j.isBlockBoundary() : !i.contains(j))
                                                    break;
                                            ...
                                            for (; n; ) {
                                                t = false;
                                                if (n.type == CKEDITOR.NODE_COMMENT)
                                                    n = n.getPrevious();
                                                else {
                                                    if (n.type == CKEDITOR.NODE_TEXT) {
                                                        ...
                                                        t = /[\s\ufeff]$/.test(g)
                                                            ...
                                                            0 || b && n.is("br")) && !n.data("cke-bookmark"))
                                                        if (h && CKEDITOR.dtd.$removeEmpty[n.getName()]) {
                                                            g = n.getText();
                                                            if (e.test(g))
                                                                n = null;
                                                            else
                                                                for (var l = n.$.getElementsByTagName("*"), I = 0, B; B = l[I++]; )
                                        ...
                                        if (t.type == CKEDITOR.NODE_TEXT)
                                            if (CKEDITOR.tools.trim(t.substring(l)).length)
                                                h = true;
                                            else {
                                                h = !t.getLength();
                                                if (l == t.getLength()) {
                                        ...
                                        for (; j || n; ) {
                                            ...
                                            for (; n; ) {
                                                ...
                                                if (n.type == CKEDITOR.NODE_TEXT) {
                                                    ...
                                                    if ((n.$.offsetWidth > 0 || b && n.is("br")) && !n.data("cke-bookmark"))
                                                        if (h && CKEDITOR.dtd.$removeEmpty[n.getName()]) {
                                                            g = n.getText();
                                                            if (e.test(g))
                                                                n = null;
                                    ...
                                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                                        ...
                                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                                            ...
                                            if ((j = j.previous()) && j.type == CKEDITOR.NODE_ELEMENT && j.is("br"))
                                                break
                                        }
                                        j = this.clone();
                                        j.collapse();
                                ...
                                if (!this.collapsed) {
                                    ...
                                    if (m)
                                        (f = e[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" : "next"]()) && this.setStartAt(f, b ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_START);
                                    if (j) {
                                        e.reset();
            ...
            (function() {
                ...
                function d(a, b, c) {
                    for (a = a.getNextSourceNode(b, null, c); !i(a); )
                ...
                function c(a, e, d, i) {
                    ...
                    if (!i)
                        return 0;
                    if ((g = CKEDITOR.filter.instances[i.element.data("cke-filter")]) && !g.check(e))
                        return c(a, e, d, i.remaining);
                ...
                a.prototype = {getNextParagraph: function(a) {
                        ...
                        for (this._.nextNode = null; p; ) {
                            ...
                            if (m)
                                p.type == CKEDITOR.NODE_TEXT && e.test(p.getText()) && (m = 0);
                            else {
                                var n = p.getName();
                        ...
                        if (!b) {
                            ...
                            if (!b && p && !this.enforceRealBlocks && y[p.getName()] && g.checkStartOfBlock() && g.checkEndOfBlock() && !p.equals(g.root))
                                ...
                                this._.nextNode = b.equals(f) ? null : d(g.getBoundaryNodes().endNode, 1, f)
                        }
                        if (q)
                            (q = b.getPrevious()) && q.type == CKEDITOR.NODE_ELEMENT && (q.getName() == "br" ? q.remove() : q.getLast() && q.getLast().$.nodeName.toLowerCase() == "br" && q.getLast().remove());
                        if (u)
                            (q = b.getLast()) && q.type == CKEDITOR.NODE_ELEMENT && q.getName() == "br" && (!CKEDITOR.env.needsBrFiller || q.getPrevious(i) || q.getNext(i)) && q.remove();
                        if (!this._.nextNode)
                            this._.nextNode = s || b.equals(f) || !f ? null : d(b, 1, f);
                        return b
                    }};
            ...
            (function() {
                    ...
                    if ((f || typeof a.elements != "function" || a.elements(j)) && (!a.match || a.match(b))) {
                            ...
                            a:if (a.nothingRequired)
                                ...
                                if (z = a.requiredClasses) {
                                    ...
                                    for (f = 0; f < z.length; ++f)
                                        if (CKEDITOR.tools.indexOf(j, z[f]) == -1) {
                                            f = false;
                                            break a
                                        }
                                }
                        ...
                        if (!f) {
                            if (!a.propertiesOnly)
                                c.valid = true;
                            if (!c.allAttributes)
                                c.allAttributes = d(a.attributes, b.attributes, c.validAttributes);
                            if (!c.allStyles)
                                c.allStyles =
                ...
                function c(b) {
                    ...
                    return b._.filterFunction = function(f, d, j, i, m, n, t) {
                        ...
                        if (d) {
                            ...
                            if (j) {
                                g = 0;
                                for (r = j.length; g < r; ++g)
                                    a(j[g], f, d, true, n)
                            }
                            if (l) {
                                g = 0;
                                for (r = l.length; g < r; ++g)
                                    a(l[g], f, d, false, n)
                            }
                            if (!d.valid) {
                                i.push(f);
                            ...
                            if (!d.allAttributes)
                                for (w in r)
                                    if (!n[w])
                                        if (s.test(w)) {
                                            if (w != (B = w.replace(/^data-cke-saved-/, "")) &&
                                                    !n[B]) {
                                                delete r[w];
                                                q = true
                                            }
                ...
                function f(a, b, c) {
                    var e = a.name;
                    if (n.$empty[e] || !a.children.length)
                        if (e == "hr" && b == "br")
                            a.replaceWith(q());
                        else {
                ...
                function A(a, b) {
                    ...
                    return[{element: c, left: e, right: function(a, c) {
                                c.transform(a, b)
                            }}]
                }
                function m(a) {
                ...
                CKEDITOR.filter.prototype = {allow: function(a, c, e) {
                        if (this.disabled || this.customConfig && !e || !a)
                            return false;
                        this._.cachedChecks = {};
                        var f, d;
                        if (typeof a == "string")
                                ...
                                a:{
                                    ...
                                    if (g)
                                        for (d = 0; d < g.length; ++d)
                                            if ((n = e.match(g[d])) && n[0].length == e.length) {
                                                c = true;
                                                break a
                                            }
                        ...
                        j.length && (t = true);
                        for (var r, a = [], d = w[d || (this.editor ? this.editor.enterMode : CKEDITOR.ENTER_P)]; e = j.pop(); )
                            e.type == CKEDITOR.NODE_ELEMENT ? f(e, d, a) : e.remove();
                        for (; r = a.pop(); ) {
                            e = r.el;
                            if (e.parent)
                                switch (r.check) {
                                    ...
                                    case "parent-down":
                                        e.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT &&
                                                !n[e.parent.name][e.name] && f(e.parent, d, a)
                                    }
                        }
                        return t
                        ...
                        if (typeof a == "string") {
                            j = a + "<" +
                                    (b === false ? "0" : "1") + (e ? "1" : "0") + ">";
                            if (j in this._.cachedChecks)
                                return this._.cachedChecks[j];
                            f = g(a).$1;
                            d = f.styles;
                            var m = f.classes;
                            f.name = f.elements;
                                ...
                                if (typeof b == "string")
                                    ...
                                    for (d in f)
                                        if (d ==
                                                "class") {
                                            c = a.classes.join("|");
                                            for (i = f[d].split(/\s+/); m = i.pop(); )
                                                c.indexOf(m) == -1 && a.classes.push(m)
                                        } else
                                            a.attributes[d] = f[d];
                                    for (j in e)
                                        a.styles[j] = e[j]
            ...
            CKEDITOR.resourceManager.prototype = {add: function(a, d) {
                    ...
                    CKEDITOR.scriptLoader.load(i, function(a, e) {
                        if (e.length)
                            throw'[CKEDITOR.resourceManager.load] Resource name "' + g[e[0]].join(",") + '" was not found at "' + e[0] + '".';
                        for (var i = 0; i < a.length; i++)
                            for (var f = g[a[i]], p = 0; p < f.length; p++) {
                                var h = f[p];
                                l[h] = this.get(h);
                                c[h] = 1
                            }
                    ...
                    var i = {}, g = function(b) {
                        a.call(this, b, function(a) {
                            ...
                            for (l in a) {
                                ...
                                if (!d[l]) {
                                    if (s.icons)
                                        for (var u = s.icons.split(","), f = u.length; f--; )
                                            CKEDITOR.skin.addIcon(u[f], s.path + "icons/" + (CKEDITOR.env.hidpi && s.hidpi ? "hidpi/" : "") + u[f] + ".png");
                                    d[l] = 1
                                }
                                if (q) {
                                    q.split && (q = q.split(","));
            ...
            (function() {
                function a(a, c, i) {
                    ...
                    if (c !== void 0) {
                        ...
                        if (CKEDITOR.env.ie && CKEDITOR.env.quirks && i == CKEDITOR.ELEMENT_MODE_INLINE)
                ...
                function o(a) {
                    ...
                    if (e)
                        var j = RegExp("(?:^|,)(?:" + e.replace(/\s*,\s*/g, "|") + ")(?=,|$)",
                                "g"), c = c.replace(j, ""), c = c + ("," + e);
                    if (d)
                        var i = RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g"), c = c.replace(i, "");
                    ...
                    CKEDITOR.plugins.load(c.split(","), function(c) {
                        ...
                        for (var m in c) {
                            ...
                            if (h && !a.lang[m]) {
                                h.split && (h = h.split(","));
                                if (CKEDITOR.tools.indexOf(h, a.langCode) >= 0)
                                    k = a.langCode;
                                else {
                                    k = a.langCode.replace(/-.*/, "");
                                    k = k != a.langCode && CKEDITOR.tools.indexOf(h, k) >= 0 ? k : CKEDITOR.tools.indexOf(h, "en") >= 0 ? "en" : h[0]
                                }
                                if (!g.langEntries || !g.langEntries[k])
                                    j.push(CKEDITOR.getUrl(g.path + "lang/" + k + ".js"));
                                else {
                        ...
                        CKEDITOR.scriptLoader.load(j, function() {
                            for (var c = ["beforeInit", "init", "afterInit"], j = 0; j < c.length; j++)
                                for (var i =
                                        0; i < e.length; i++) {
                                    var m = e[i];
                            ...
                            for (i = 0; i < a.config.blockedKeystrokes.length; i++)
                                a.keystrokeHandler.blockedKeystrokes[a.config.blockedKeystrokes[i]] = 1;
                            a.status = "loaded";
                            a.fireOnce("loaded");
            ...
            (function() {
                ...
                CKEDITOR.htmlParser.prototype = {onTagOpen: function() {
                        ...
                        if (b.length >
                                i)
                            this.onText(b.substring(i, b.length))
                    }}
            })();
                                ...
                                if (a(i))
                                    ...
                                    if (e == "br")
                                        ...
                                        for (; ; ) {
                                            ...
                                            if (!i.isUnknown && !m.isUnknown && !p[e])
                                                if (m.isOptionalClose)
                                                    ...
                                                    m = g
                                                } else if (e in CKEDITOR.dtd.$listItem && !u(e, g))
                                                    f.onTagOpen(e == "li" ? "ul" : "dl", {}, 0, 1);
                                                else if (g in d && !u(e, g)) {
                                                    !i.returnPoint && (i.returnPoint = m);
                                                    m = m.parent
                                                } else {
            ...
            (function() {
                ...
                CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({$: function(b) {
                        ...
                        b && this.addRules(b, 10)
                            ...
                            for (var e = [this.elementsRules["^"], this.elementsRules[c.name], this.elementsRules.$], d, g = 0; g < 3; g++)
                                if (d = e[g]) {
                                    d = d.exec(a, c, this);
                                    if (d === false)
                                        return null;
                ...
                a.prototype = {add: function(a, c, e) {
                        this.rules.splice(this.findIndex(c), 0, {value: a, priority: c, options: e})
                            ...
                            c, e) {
                        for (var d = [this.findIndex(c), 0], g = 0, l = a.length; g < l; g++)
                            d.push({value: a[g], priority: c, options: e});
                        this.rules.splice.apply(this.rules, d)
                    }, findIndex: function(a) {
                        for (var c = this.rules, e = c.length - 1; e >= 0 && a < c[e].priority; )
                            e--;
                        return e + 1
                    }, exec: function(a, c) {
                        ...
                        for (s = 0; s < l; s++) {
                            ...
                            if (!(a.nonEditable && !o.options.applyToAll ||
                                ...
                                if (o === false || e && o && (o.name != k || o.type != h))
                                    return o;
                                o != void 0 && (d[0] = c = o)
                            }
                        }
            ...
            (function() {
                function a(a, d) {
                        ...
                        return function(d) {
                            if (d.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                                ...
                                if (j = CKEDITOR.env.opera && !a || (typeof e == "function" ? e(d) !==
                                        false : e))
                                    if (!h && !CKEDITOR.env.needsBrFiller && d.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT)
                                        j = false;
                                    else if (!h && !CKEDITOR.env.needsBrFiller && (document.documentMode > 7 || d.name in CKEDITOR.dtd.tr || d.name in CKEDITOR.dtd.$listItem))
                                        j = false;
                                    else {
                                        j = b(d);
                    ...
                    function t(a, b) {
                        if ((!h || CKEDITOR.env.needsBrFiller) && a.type == CKEDITOR.NODE_ELEMENT && a.name == "br" && !a.attributes["data-cke-eol"])
                            return true;
                        var c;
                        if (a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(y))) {
                            ...
                            if (!CKEDITOR.env.needsBrFiller && h && (!b || a.parent.name in p))
                                return true;
                            if (!h)
                                if ((c = a.previous) && c.name == "br" || !c || i(c))
                                    return true
                        }
                        return false
                    }
                    ...
                    for (r in p)
                        "#"in m[r] || delete p[r];
                    for (r in p)
                        v.elements[r] = j(h, a.config.fillEmptyBlocks !== false);
                    v.root = j(h);
                ...
                var y = /(?:&nbsp;|\xa0)$/, A = "{cke_protected}",
                        m = CKEDITOR.dtd, j = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"], n = CKEDITOR.tools.extend({}, m.$blockLimit, m.$block), r = {elements: {input: l, textarea: l}}, J = {attributeNames: [[/^on/, "data-cke-pa-on"], [/^data-cke-expando$/, ""]]}, t = {elements: {embed: function(a) {
                            var b = a.parent;
                            if (b && b.name == "object") {
                ...
                w = {elementNames: [[/^cke:/, ""], [/^\?xml:namespace$/, ""]], attributeNames: [[/^data-cke-(saved|pa)-/, ""], [/^data-cke-.*/, ""], ["hidefocus", ""]], elements: {$: function(a) {
                            var b = a.attributes;
                            if (b) {
                                if (b["data-cke-temp"])
                                    return false;
            ...
            (function() {
                ...
                CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function() {
                        ...
                        for (var b = this.children.splice(a, this.children.length - a), d = this.clone(), g = 0; g < b.length; ++g)
                            b[g].parent = d;
                        d.children = b;
                        if (b[0])
                            b[0].previous = null;
            ...
            (function() {
                ...
                CKEDITOR.inlineAll = function() {
                    ...
                    for (b in CKEDITOR.dtd.$editable)
                        for (var c = CKEDITOR.document.getElementsByTag(b), e = 0, i = c.count(); e < i; e++) {
                            a = c.getItem(e);
                            if (a.getAttribute("contenteditable") == "true") {
                                d = {element: a, config: {}};
                    ...
                    for (var a = document.getElementsByTagName("textarea"), b = 0; b < a.length; b++) {
                        ...
                        if (d.name || d.id) {
                            if (typeof arguments[0] == "string") {
                                if (!RegExp("(?:^|\\s)" + arguments[0] + "(?:$|\\s)").test(d.className))
                                    continue
                            } else if (typeof arguments[0] == "function") {
                                c = {};
                                if (arguments[0](d, c) === false)
                                    continue
                            }
                            this.replace(d, c)
                        }
            ...
            (function() {
                ...
                CKEDITOR.editable = CKEDITOR.tools.createClass({base: CKEDITOR.dom.element, $: function(a, b) {
                        ...
                        this.setup()
                            ...
                            if (!b) {
                                var e = /\n{2}/g;
                                if (e.test(a))
                                    var j = "<" + c + ">", n = "</" + c + ">", a = j + a.replace(e, function() {
                                    return n + j
                                }) + n
                            }
                            a = a.replace(/\n/g, "<br>");
                            ...
                            var n, i;
                            if (j)
                                for (; (n = b.getCommonAncestor(0, 1)) && (i = CKEDITOR.dtd[n.getName()]) && (!i || !i[e]); )
                                    if (n.getName()in CKEDITOR.dtd.span)
                                        b.splitElement(n);
                            ...
                            if (this.insertElementIntoRange(a, e)) {
                                ...
                                if (m)
                                    if ((m = a.getNext(function(a) {
                                        return c(a) && !h(a)
                                    })) && m.type == CKEDITOR.NODE_ELEMENT && m.is(CKEDITOR.dtd.$block))
                                        m.getDtd()["#"] ? e.moveToElementEditStart(m) : e.moveToElementEditEnd(a);
                                    else if (!m && d != CKEDITOR.ENTER_BR) {
                                ...
                                this.attachListener(a, "key", function(b) {
                                    ...
                                    if (c in m) {
                                        ...
                                        if (CKEDITOR.env.ie && CKEDITOR.env.version < 11 && (e = b.getSelectedElement()) || (e = i(b))) {
                                            ...
                                            if ((k = h.block) && (p = k[c ? "getPrevious" : "getNext"](o)) && p.type == CKEDITOR.NODE_ELEMENT && p.is("table") &&
                                                ...
                                                a.fire("saveSnapshot");
                                                d = 1
                                            } else if ((l = h.contains(["td", "th", "caption"])) && g.checkBoundaryOfElement(l, c ? CKEDITOR.START : CKEDITOR.END))
                                                d = 1
                                    }
                                    return!d
                                });
                ...
                CKEDITOR.editor.prototype.editable = function(a) {
                    ...
                    if (b && a)
                        return 0;
                    if (arguments.length)
                        b = this._.editable = a ? a instanceof CKEDITOR.editable ? a : new CKEDITOR.editable(this, a) : (b && b.detach(),
                                null);
                    return b
                };
                    ...
                    function b(c, d) {
                        ...
                        for (var t =
                            ...
                            if (a(e)) {
                                ...
                                g.push({isElement: 0, node: e,
                                    allowed: 1})
                        }
                        if (l > -1)
                            g[l].firstNotAllowed = 1;
                        if (o > -1)
                            g[o].lastNotAllowed = 1;
                        return g
                    }
                    function d(b, c) {
                    ...
                    return function(i, h, k) {
                        ...
                        if (!o.checkReadOnly()) {
                            ...
                            for (; (z = a(r.startContainer) &&
                                    r.startContainer.getChild(r.startOffset - 1)) && a(z) && z.isBlockBoundary() && C.contains(z); )
                                r.moveToPosition(z, CKEDITOR.POSITION_BEFORE_END);
                            ...
                            for (v = x.startNode; (v = v.getParent()) && e(v); )
                                q.push(v);
                            r.moveToBookmark(x);
                            if (x = k) {
                                x = h.range;
                                ...
                                if (/^\s+|\s+$/.test(k) && "span"in CKEDITOR.dtd[z])
                                    var s = '<span data-cke-marker="1">&nbsp;</span>', k = s + k + s;
                                ...
                                if ((s = x.startPath().block) && !(s.getChildCount() == 1 && s.getBogus()))
                                    a:{
                                        var E;
                            ...
                            for (R = K.createBookmark(); F = h.zombies.pop(); )
                                if (F.getParent()) {
                                    O = K.clone();
                            ...
                            if (Q)
                                for (; F = Q.pop(); )
                                    CKEDITOR.env.needsBrFiller ? F.appendBogus() :
                                            F.append(K.document.createText(" "));
                            for (; F = h.mergeCandidates.pop(); )
                                F.mergeSiblings();
                            K.moveToBookmark(R);
                            if (!h.dontMoveCaret) {
                                for (F = a(K.startContainer) && K.startContainer.getChild(K.startOffset - 1); F && a(F) && !F.is(n.$empty); ) {
                                    if (F.isBlockBoundary())
                                        K.moveToPosition(F, CKEDITOR.POSITION_BEFORE_END);
                                    else {
            ...
            (function() {
                ...
                CKEDITOR.on("instanceCreated", function(b) {
                    ...
                    e.on("contentDom", function() {
                        ...
                        CKEDITOR.env.gecko && f.attachListener(f, "focus", function(a) {
                            a.removeListener();
                            if (h !== 0)
                                if ((a = e.getSelection().getNative()) && a.isCollapsed && a.anchorNode == f.$) {
                                    a = e.createRange();
                        ...
                        if (m ? CKEDITOR.env.webkit || CKEDITOR.env.gecko : CKEDITOR.env.opera) {
                            ...
                            f.attachListener(CKEDITOR.env.ie ? f : b.getDocumentElement(), "mouseup", d, e);
                    ...
                    e.on("key", function(a) {
                        if (e.mode == "wysiwyg") {
                            ...
                            if (b.isFake) {
                                ...
                                if (c)
                                    return c({editor: e, selected: b.getSelectedElement(), selection: b, keyEvent: a})
                            }
                        }
                    })
                });
                ...
                CKEDITOR.dom.selection = function(a) {
                    ...
                    if (CKEDITOR.env.webkit)
                        (b.type == "None" && this.document.getActive().equals(a) || b.type == "Caret" && b.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && l(a, b);
                    else if (CKEDITOR.env.gecko)
                        b && (this.document.getActive().equals(a) && b.anchorNode && b.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && l(a, b, true);
                        ...
                        if (p)
                            b.type == "None" && (d && d.equals(this.document.getDocumentElement())) && l(a, null, true);
                        else {
                    ...
                    if (d)
                        if (d.getRangeAt)
                            f = (i = d.rangeCount && d.getRangeAt(0)) && new CKEDITOR.dom.node(i.commonAncestorContainer);
                        else {
                            try {
                                i = d.createRange()
                            } catch (g) {
                ...
                CKEDITOR.dom.selection.prototype =
                        {getNative: function() {
                                ...
                                if (!c || !c.rangeCount)
                                    ...
                                    if (d == c.endContainer && d.nodeType == 1 && c.endOffset - c.startOffset == 1 && A[d.childNodes[c.startOffset].nodeName.toLowerCase()])
                                        b = CKEDITOR.SELECTION_ELEMENT
                                }
                                return a.type = b
                            }, getRanges: function() {
                                var a = p ? function() {
                                    ...
                                    var b = function(b, c) {
                                        ...
                                        g = g.text.replace(/(\r\n|\r)/g, "\n").length;
                                        if (!g)
                                            return{container: d, offset: a(f) + (k > 0 ? 0 : 1)};
                                        for (; g > 0; )
                                            try {
                                ...
                                var b = this, c = CKEDITOR.tools.tryThese(function() {
                                    ...
                                    for (var a = b.getRanges()[0].clone(), c, d, e = 2; e && (!(c = a.getEnclosedNode()) || !(c.type == CKEDITOR.NODE_ELEMENT && A[c.getName()] && (d = c))); e--)
                                ...
                                if (b)
                                    for (var b = this.root, d, e = 0; e < a.length; ++e) {
                                        d = a[e];
                                        if (d.endContainer.equals(b))
                                            d.endOffset = Math.min(d.endOffset, b.getChildCount())
                                    }
                                if (a.length)
                                    if (this.isLocked) {
                                        ...
                                        a:{
                                            ...
                                            if (a.length == 1 && !(k = a[0]).collapsed && (g = k.getEnclosedNode()) && g.type == CKEDITOR.NODE_ELEMENT) {
                                                ...
                                                k.shrink(CKEDITOR.SHRINK_ELEMENT,
                                                        true);
                                                if ((h = k.getEnclosedNode()) && h.type == CKEDITOR.NODE_ELEMENT)
                                                    g = h;
                                        ...
                                        if (g)
                                            ...
                                            if (p) {
                                                ...
                                                if ((d = g.getEnclosedNode()) && d.type == CKEDITOR.NODE_ELEMENT && d.getName()in A && (!d.is("a") || !d.getText()))
                                                    try {
                                                ...
                                                for (q = 0; q < a.length; q++) {
                                                    ...
                                                    if (g.collapsed && CKEDITOR.env.webkit && c(g)) {
                                                        ...
                                                        if ((l = h.getNext()) && !h.getPrevious() &&
                                                            ...
                                                            g.moveToPosition(h, CKEDITOR.POSITION_AFTER_END)
                                                    }
            ...
            (function() {
                        ...
                        for (o.getPosition(n) == CKEDITOR.POSITION_FOLLOWING && (o = 0); o; ) {
                            ...
                            if (o.equals(n)) {
                                ...
                                if (p && j && CKEDITOR.dtd.$block[s])
                                    for (var t = o, w = c(t), A = void 0, B = w.length, G = 0, t = B && new CKEDITOR.dom.range(t.getDocument()); G < B; ++G) {
                                ...
                                if (w)
                                    if ((w = o.getParent()) && ((w.getDtd() || CKEDITOR.dtd.span)[f] || i) && (!g.parentRule || g.parentRule(w))) {
                                        ...
                                        if (s == CKEDITOR.NODE_TEXT || p || s == CKEDITOR.NODE_ELEMENT && !o.getChildCount()) {
                                            for (var s = o, W; (h = !s.getNext(I)) && (W = s.getParent(), k[W.getName()]) && (W.getPosition(m) | H) == H && (!g.childRule || g.childRule(W)); )
                                                s = W;
                                            q.setEndAfter(s)
                                        }
                                    } else
                            ...
                            if (h && q && !q.collapsed) {
                                for (var h = y(this, e), p = h.hasAttributes(), r = q.getCommonAncestor(), s = {}, w = {}, A = {}, B = {}, S, P, Y; h && r; ) {
                                    if (r.getName() == f) {
                                        for (S in g.attributes)
                                            if (!B[S] &&
                                                    (Y = r.getAttribute(P)))
                                                h.getAttribute(S) == Y ? w[S] = 1 : B[S] = 1;
                                        for (P in g.styles)
                                            if (!A[P] && (Y = r.getStyle(P)))
                                                h.getStyle(P) == Y ? s[P] = 1 : A[P] = 1
                                    }
                                    r = r.getParent()
                                }
                                for (S in w)
                ...
                function h(a, b) {
                    ...
                    if (d && !e) {
                        ...
                        f ? b = s(c ? [a.getHtml()] : k(a), b) : a.moveChildren(b);
                    b.replace(a);
                    if (d) {
                        var c = b, h;
                ...
                function q(a, b) {
                    ...
                    for (h in d)
                        if (!((h == "class" || this._.definition.fullMatch) && a.getAttribute(h) != n(h, d[h])) && !(b && h.slice(0, 5) == "data-")) {
                            g = a.hasAttribute(h);
                            a.removeAttribute(h)
                        }
                    for (var i in c)
                        if (!(this._.definition.fullMatch && a.getStyle(i) != n(i, c[i], true))) {
                            g = g || !!a.getStyle(i);
                            a.removeStyle(i)
                        }
                    f(a, e, J[a.getName()]);
                                ...
                                if (l && a.length > 1) {
                                    if (!i)
                                        for (var h = a.length - 1; h >= 0; h--)
                                            d.unshift(a[h].createBookmark(true));
                                    if (g)
                                        for (var k = 0; a[i + k + 1]; ) {
                                            ...
                                            1].startNode); ; ) {
                                                ...
                                                if (o.equals(h))
                                                    g = 1;
                                                else if (c(h) || h.type == CKEDITOR.NODE_ELEMENT && h.isBlockBoundary())
                                                    continue;
                                                break
                                            }
                                            if (!g)
            ...
            CKEDITOR.plugins.add("link", {requires: "dialog,fakeobjects", onLoad: function() {
                    ...
                    c && c.push(function(a, c) {
                        if ("a" == c && (CKEDITOR.plugins.link.tryRestoreFakeAnchor(b, a) || a.getAttribute("name") && (!a.getAttribute("href") || !a.getChildCount())))
                            return"anchor"
                    })
                }});
            CKEDITOR.plugins.link = {getSelectedLink: function(b) {
                    ...
                    for (var a = b.editable(), d = a.isInline() && !b.plugins.divarea ? b.document : a, c = d.getElementsByTag("a"), a = [], f = 0, e; e = c.getItem(f++); )
                        if (e.data("cke-saved-name") || e.hasAttribute("name"))
                            a.push({name: e.data("cke-saved-name") || e.getAttribute("name"),
                                id: e.getAttribute("id")});
                    if (this.fakeAnchor) {
                        d = d.getElementsByTag("img");
                        for (f = 0; e = d.getItem(f++); )
                            (e = this.tryRestoreFakeAnchor(b, e)) && a.push({name: e.getAttribute("name"), id: e.getAttribute("id")})
                    }
                    return a
