...
isset($_GET['id_group']) && is_numeric($_GET['id_group']) &&
...
$sql_max_id = "SELECT MAX(id_chat) AS max_id FROM chat_grupo";
...
$sql_messages .= "(SELECT * FROM chat_grupo WHERE grupo_id=$id_group ORDER BY id_chat DESC LIMIT $num_messages) ";
