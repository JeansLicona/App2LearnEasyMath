...
if($num_rows>0)
{
	...
	while ($message = mysqli_fetch_array($result))
    {
		...
		if($num_row_user==1)
		{
			...
			$content .= "<div id='container_message'>";
			$content .= "<div id='name_user'>".$data_user."</div>";
			$content .= "<div id='container_text_message'>".$message['mensaje']."</div>";
			$content .= "<div id='date_hour'>".$date_array[1]." ".$current_date."</div>";
			$content .= "</div>";
	...
	if($table!="" && $user_type!="")
	{
		...
		if(mysqli_num_rows($result_info)==1)
		{
			...
			$content .= "<div id='container_message'>";
			$content .= "<div id='name_user'>".$info['nombres'].' '.$info['apellidos']."</div>";
			$content .= "<div id='container_text_message'>".$message['mensaje']."</div>";
			$content .= "<div id='date_hour'>".$date_array[1]." ".$current_date."</div>";
			$content .= "</div>";
